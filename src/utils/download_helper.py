...
# def get_media_filepath(filepath=None):
#     from os import path, listdir
#     # Return the downloaded file path
#     if path.exists(filepath):
#         filename = utils.generate_short_strings(3)
#         res = next(f for f in listdir(filepath) if f.startswith(filename))

#         return path.join(filepath, res)